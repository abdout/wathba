...
const Footer = ({ dict = {}, lang = 'en' }) => {
    ...
    const linkSections = [
        {
            title: dict?.footer?.sections?.products?.title || "PRODUCTS",
            links: (dict?.footer?.sections?.products?.items || ["Earphones", "Headphones", "Smartphones", "Laptops"]).map(item => ({
                text: item,
                path: '/',
                icon: null
            }))
        ...
        {
            title: dict?.footer?.sections?.website?.title || "WEBSITE",
            links: [
                { text: dict?.footer?.sections?.website?.home || "Home", path: '/', icon: null },
                { text: dict?.footer?.sections?.website?.privacy || "Privacy Policy", path: '/', icon: null },
                { text: dict?.footer?.sections?.website?.plus || "Become Plus Member", path: '/pricing', icon: null },
                { text: dict?.footer?.sections?.website?.createStore || "Create Your Store", path: '/create-store', icon: null },
            ]
        },
        {
            title: dict?.footer?.sections?.contact?.title || "CONTACT",
            links: [
                { text: dict?.footer?.sections?.contact?.phone || "+1-212-456-7890", path: 'tel:+971502731313', icon: PhoneIcon },
                { text: dict?.footer?.sections?.contact?.email || "contact@example.com", path: 'mailto:sales@alwathbacoop.ae', icon: MailIcon },
                { text: dict?.footer?.sections?.contact?.location || "794 Francisco, 94102", path: 'https://www.google.com/maps/place/%D9%85%D8%B1%D9%83%D8%B2+%D8%AA%D8%B3%D9%88%D9%82+%D8%AC%D9%85%D8%B9%D9%8A%D8%A9+%D8%A7%D9%84%D9%88%D8%AB%D8%A8%D8%A9+%D8%A7%D9%84%D8%AA%D8%B9%D8%A7%D9%88%D9%86%D9%8A%D8%A9+Al-Wathbah+shopping+center%E2%80%AD/@24.2798025,54.6537776,15z/data=!4m10!1m2!2m1!1z2KzZhdi52YrYqSDYp9mE2YjYq9io2Kk!3m6!1s0x3e5e312f5dc06717:0x83f6d422255d019f!8m2!3d24.2798025!4d54.671802!15sChfYrNmF2LnZitipINin2YTZiNir2KjYqZIBG3Byb3BlcnR5X21hbmFnZW1lbnRfY29tcGFueaoBXQoNL2cvMTF5NGJkYnlieAoML2cvMTJscjduaHgyEAEyHxABIhu21CB9Y2UGjVpsBigQbVx3jKa7J-B9HwfmObIyGxACIhfYrNmF2LnZitipINin2YTZiNir2KjYqeABAA!16s%2Fg%2F11y4bdbybx?entry=ttu&g_ep=EgoyMDI1MDkyNC4wIKXMDSoASAFQAw%3D%3D', icon: MapPinIcon }
            ]
        }
    ];

    const socialIcons = [
        { icon: FacebookIcon, link: "https://www.facebook.com/alwathbacooperativesociety" },
        { icon: InstagramIcon, link: "https://www.instagram.com/coopalwathba" },
                            ...
                            <div key={index}>
                                ...
                                <ul className="space-y-2.5">
                                    {section.links.map((link, i) => {
                                        const isContactInfo = section.title === (dict?.footer?.sections?.contact?.title || "CONTACT");
                                        const needsLTR = isContactInfo && (link.icon === PhoneIcon || link.icon === MailIcon);
