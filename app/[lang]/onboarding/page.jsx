  ...
  const handleRoleSelection = async (role) => {
    ...
    try {
      const result = await completeOnboarding({
        role: role,
        onboardingComplete: role === 'customer', // Customers complete onboarding immediately
      });
      ...
      if (result.success) {
        ...
        if (role === 'vendor') {
          // Redirect vendors to store setup
          router.push('/onboarding/vendor');
        } else {
          // Redirect customers to home
          toast.success('Welcome to Alwathba!');
          router.push('/');
        }
      } else {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Please select how you want to use Alwathba
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="space-y-4">
            ...
            >
              ...
              <h3 className="text-lg font-medium text-gray-900">I want to shop</h3>
