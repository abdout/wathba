                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-28 mb-20">
                        <div className="space-y-8">
                            <div className="space-y-6">
                                <div className="text-[#1D77B6] text-sm font-medium tracking-[0.3em] uppercase">
                        ...
                        <div className="max-w-4xl mx-auto text-center space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                                <div className="space-y-4">
                                    <div className="w-16 h-16 bg-[#1D77B6] rounded-full flex items-center justify-center mx-auto">
                                ...
                                return (
                                    <div key={index} className="text-center space-y-4">
                                        <div className="relative w-48 h-48 mx-auto">
                                            <div className="absolute inset-0 bg-[#1D77B6] rounded-full"></div>
                                            <OptimizedImage
                                                src={imageSrc}
                                                alt={member.name}
                                                width={200}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className={`text-[#1D77B6] text-sm font-medium ${lang === 'ar' ? 'font-arabic' : ''}`}>
                                                {member.position}
                                            </p>
                                        </div>
                                    </div>
