                        ...
                        <tbody className="divide-y divide-gray-100">
                            {orders.map((order, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 font-medium text-slate-800"><span className="inline-flex items-center gap-0.5"><CurrencyIcon className="w-3.5 h-3.5" width={14} height={14} />{order.total}</span></td>
                                ...
                                {selectedOrder.orderItems.map((item, i) => (
                                    <div key={i} className="flex items-center gap-4 border border-slate-100 shadow rounded p-2">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="flex items-center gap-0.5">Price: <CurrencyIcon className="w-3 h-3" width={12} height={12} />{item.price}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
